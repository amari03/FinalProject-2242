...
//Var contains the variables for the error message
var (
...
func Write(w http.ResponseWriter, cookie http.Cookie) error { 
	//Takes in a .responseWriter and a http.cookie and returns an error

	// Encoding the cookie value using base64.
